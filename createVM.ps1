...
$resourceGroup = "md-az-resourceGroup"
$location = "westus"
$vmName = "md-test-VM"
...
# Configure SSH Keys
$sshPublicKey = Get-Content "/Users/mdune/.ssh/id_rsa.pub"
Add-AzVMSshPublicKey -VM $vmconfig -KeyData $sshPublicKey -Path "/Users/mdune/.ssh/authorized_keys"
